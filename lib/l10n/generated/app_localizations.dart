...
abstract class AppLocalizations {
  ...
  /// No description provided for @availableChores.
  ///
  /// In en, this message translates to:
  /// **'Available Chores'**
  String get availableChores;
  ...
  /// No description provided for @expiredMissed.
  ///
  /// In en, this message translates to:
  /// **'Expired — Missed'**
  String get expiredMissed;

  /// No description provided for @noChoresNow.
  ///
  /// In en, this message translates to:
  /// **'No chores available right now.'**
  String get noChoresNow;
  ...
  /// No description provided for @acceptChoreQ.
  ///
  /// In en, this message translates to:
  /// **'Do you want to accept this chore?'**
  String get acceptChoreQ;

  /// No description provided for @choreOptions.
  ///
  /// In en, this message translates to:
  /// **'Chore Options'**
  String get choreOptions;
  ...
  /// Short deadline label
  ///
  /// In en, this message translates to:
  /// **'Before {time}'**
  String deadlineShort(String time);

  /// Formats count for headers
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{0} one{1} other{{count}}}'**
